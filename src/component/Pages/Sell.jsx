...
export default function Sell() {
    ...
    const runFilter = () => {
        ...
        const filteredProperties = properties.filter((property) => {
          ...
          return localityMatch &&  sellMatch && categoryMatch && searchMatch;
        });
    ...
    return (
        <div className="bg-[#F3F4F6] min-h-screen pt-20 border-1 border-gray-100">
    ...
    PG
      ...
      >
        <FaPhoneAlt />
            ...
            {/* <div
                className='w-full h-[525px] flex bg-white mt-2 justify-center relative'
            ...
            >
                {images.length > 0 ? (
                    <Carousel
                        ...
                        showIndicators={true}
                        showStatus={false}
                        className="w-[600px] h-[400px] mt-8 max-w-screen-xl shadow-2xl rounded-2xl"
                    >
                            ...
                            return (
                                <div key={index} className="relative">
                                    <img
                                        ...
                                        className="w-full h-full aspect-[16/11] object-cover rounded-lg"
                                    />
                                    {property && (
                                        <div className="absolute bottom-0 flex left-0 w-full bg-blue-400/90 text-white p-4 rounded-b-lg">
                                            <CiLocationOn className='h-7 w-7 text-white' />
                                            <h1 className="text-xl font-bold text-white truncate">{property.location?.society || 'Unknown Society'}</h1>
                                            <GoDotFill className='mt-2 ml-4' />
                                            <h2 className="text-lg ml-5 font-bold text-white truncate">{property.location?.locality || 'Unknown Locality'}</h2>
                                        </div>
                                    )}
                                </div>
                            );
